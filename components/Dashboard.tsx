        ...
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm" title="A high-level overview of the most important marketing metrics.">
                <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                    <div>
                        <h2 className="text-xl font-bold text-gray-800">Performance Marketing Dashboard</h2>
            ...
            {/* Social Media Competition */}
                ...
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-bold text-gray-800">Social Media Competition</h3>
                    <a href="#" className="text-sm font-semibold text-blue-600 hover:underline">View Competitors</a>
                </div>
                ...
                <div className="h-64 mt-6">
                    ...
                    <BarChart data={data.socialMediaCompetitionChart}>
                        ...
                        <Bar dataKey="engagementRate" fill="#34d399" name="Engagement Rate %" />
                    </BarChart>
                    </ResponsiveContainer>
                </div>
                </div>
                ...
                {/* Social Media Content Performance */}
                    <div className="bg-white p-6 rounded-xl shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-lg font-bold text-gray-800">Social Media Content Performance</h3>
                        <a href="#" className="text-sm font-semibold text-blue-600 hover:underline">View Content</a>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            <YAxis stroke="#9ca3af" />
                            <Tooltip />
                            <Area type="monotone" dataKey="completionRate" stroke="#f43f5e" fill="#f43f5e20" />
                            </AreaChart>
                        </ResponsiveContainer>
                        </div>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-lg font-bold text-gray-800">Social Listening Metrics</h3>
                        <a href="#" className="text-sm font-semibold text-blue-600 hover:underline">View Trends</a>
                    </div>
